...
import br.com.sisescola.exe.Disciplina;
import java.sql.*;
...
public class DisciplinaDAO {
    ...
    public ResultSet carregarGrade()throws Exception{   
        ...
        return stm.executeQuery(
                "SELECT CODDIS, NOME, ID_PROFESSOR FROM DISCIPLINA ORDER BY NOME");
    }
    
    public Vector<Disciplina> carregarCombo()throws Exception{
        Statement stm = ce.getConexao().createStatement();
        ResultSet rs = stm.executeQuery(
                "SELECT CODDIS, NOME FROM DISCIPLINA ORDER BY NOME");
    ...
    public Disciplina pesquisar(int coddis)throws Exception{
        ...
        return new Disciplina(rs.getInt("CODDIS"), rs.getString("NOME"), rs.getInt("ID_PROFESSOR"));
    }
